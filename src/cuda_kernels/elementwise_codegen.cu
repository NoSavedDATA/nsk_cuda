...
//extern "C" DT_tensor *logE(Scope_Struct *scope_struct, int thread_id, DT_tensor tensor) {
...
//  DT_tensor *new_tensor = createTensor(scope_struct, device_y, dims, kDataLen, false, "");
//  return new_tensor;
//}

//extern "C" DT_tensor *logE2(Scope_Struct *scope_struct, int thread_id, DT_tensor tensor) {
...
//extern "C" DT_tensor *clip(Scope_Struct *scope_struct, int thread_id, DT_tensor tensor, float _min, float _max)
//{
...
//  DT_tensor *new_tensor = createTensor(scope_struct, device_y, dims, tensor.dims_prod, false, "");
