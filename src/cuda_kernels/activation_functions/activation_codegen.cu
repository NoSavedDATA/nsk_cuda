...
extern "C" DT_tensor *relu(Scope_Struct *scope_struct, DT_tensor *tensor)
{
  ...
  return customOpTensor(scope_struct, y, dims, DimsProd(dims), "relu_backward", nullptr, tensor, has_grad);
}
...
extern "C" DT_tensor *gelu(Scope_Struct *scope_struct, DT_tensor *tensor)
{
  ...
  return customOpTensor(scope_struct, y, dims, DimsProd(dims), "gelu_backward", nullptr, tensor, has_grad);
}
...
extern "C" DT_tensor *sigmoid(Scope_Struct *scope_struct, DT_tensor *tensor)
{
  ...
  return customOpTensor(scope_struct, y, dims, DimsProd(dims), "sigmoid_backward", nullptr, tensor, has_grad);
}
...
extern "C" DT_tensor *_tanh(Scope_Struct *scope_struct, DT_tensor *tensor)
{
  ...
  return customOpTensor(scope_struct, y, dims, DimsProd(dims), "tanh_backward", nullptr, tensor, has_grad);
}
...
extern "C" DT_tensor *softmax(Scope_Struct *scope_struct, DT_tensor *tensor)
{
  ...
  */
  ...
  DT_tensor *new_tensor = createTensor(scope_struct, probs, tensor->dims, tensor->dims_prod, false, "");
