...
//  DT_tensor *new_tensor = createTensor(scope_struct, cropped, dims, dims_prod, false, "", tensor->cuda_stream);
...
//  DT_tensor *new_tensor = createTensor(scope_struct, flipped, dims, dims_prod, false, "", tensor->cuda_stream);
...
//  { 
//    LogErrorC(scope_struct->code_line, "NormalizeImg mean and std tensors must have the same dimensionality as the image channels.");
//    return nullptr;
//  }
...
//  DT_tensor *new_tensor = createTensor(scope_struct, normalized, dims, dims_prod, false, "", tensor->cuda_stream);
...
//  DT_tensor *new_tensor = createTensor(scope_struct, jittered, tensor->dims, dims_prod, false, "", tensor->cuda_stream);
