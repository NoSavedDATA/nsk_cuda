...
//  if (dims.size()<=1)
//    LogErrorC(-1, "Cannot remove the batch dimension of a unidimensional tensor.");
...
//  {
//    return {1.0f};
//    //LogErrorC("Cannot remove the batch dimension of a unidimensional tensor.");
//  }
...
//  {
//    LogErrorC(-1, "The last dimension of multiplied tensors must be the same.");
//    return {}; 
//  }
//  for (int i = 0; i < Ldims.size()-1; i++)
